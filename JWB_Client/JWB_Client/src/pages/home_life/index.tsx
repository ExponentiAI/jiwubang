...
import { WTab, WTab_life,WMessageItem } from '../../components/widget'
...
import './index.less'
import { scrollUpIco, bottomIcon,life2medical } from '../../assets/images/icon'
...
export default class Index extends Component<{}, State> {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      type:'life',
      modalShow:false,
      modalContent:'\n\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b切换到医疗物资？',
...
getDistance(value) {
  ...
  handleConfirm(){Taro.redirectTo({ url: `/pages/home/index` })}
