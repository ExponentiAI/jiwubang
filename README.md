...
针对 2020 年初爆发的新型冠状病毒肺炎（简称：新冠肺炎）疫情，本项目旨在收集居民和群众反馈的周边超市、药店卖口罩和消毒液的情况（位置、门店、基本类别、价格），便于这阶段居民出门购物和找到合适的地方购买口罩和消毒液。同时，面向海外华人社区的第二版推出了生活服务（医疗互助、复工招聘、餐饮配送、超市代购、玩具互换）和社交联系功能。
...
微信小程序前端信息发布、查询、交互开发基于Taro框架，第一版后台数据管理和维护基于Python+Django+Rest框架，第二版后台数据管理和维护基于Spring+SpringMVC+MyBatis框架，同时积极组建专业团队持续更新前端交互功能需求，以及后台可能面临的存储、读写、并发、IO、管控等性能优化方案。项目相关代码和设计（第一版）已经在Github托管平台开源，方便更多开源社区爱好者了解项目，加入项目，一起参与改进和维护。
